    ...
    <div className="flex  min-h-[869px] dark:bg-black max-md:min-h-[760px]">
        <div className="flex flex-col items-center justify-center w-1/2 gap-10 max-md:hidden">
            <div>
                ...
                <h3 className="text-[1.3rem] font-[300] ml-1 mt-1 text-gray-400 dark:text-zinc-400 ">Your space to explore, share and connect through words</h3>
            </div>
            <img src={home} className='w-[500px] mx-auto' />
         </div>
...
return !loading ?(
  <div className='w-full bg-gray-100 dark:bg-zinc-900'>
    <div className='w-full h-[350px] dark:bg-black py-60 flex flex-col justify-center items-center bg-white max-md:py-5 max-md:h-[200px]'>
        ...
        <h2 className="mb-4 text-3xl text-center text-gray-300 dark:text-gray-600 max-md:text-xl max-md:hidden">Stay updated with the latest trends, tips, and stories from the world of blogging</h2>
    </div>
